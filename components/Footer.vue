<template>
    <div>
        <div class="lg:py-120 py-20 border-b border-[#1C2134]">
            <div class="mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div
                    ...
                    <div class="md:col-span-3 lg:col-span-2 pt-8 lg:pt-0 lg:pl-12">
                        <h4 class="mb-7 text-black text-2xl font-semibold">Links</h4>
                        <nav>
                            <ul class="space-y-4">
                                <li>
                                    <a href="#"
                                        class="font-medium text-base text-black transition hover:text-pblue-500">Home</a>
                                </li>
                                <li>
                                    <a href="#"
                                        class="font-medium text-base text-black transition hover:text-pblue-500">Service</a>
                                </li>
                                <li>
                                    <a href="#"
                                        class="font-medium text-base text-black transition hover:text-pblue-500">Blog</a>
                                </li>
                                <li>
                                    <a href="#"
                                        class="font-medium text-base text-black transition hover:text-pblue-500">Contact
                                        Us</a>
                                </li>
                            </ul>
                        </nav>
                    ...
                    <div class="md:col-span-3 lg:col-span-3 pt-8 lg:pt-0 lg:pl-12">
                        <h4 class="mb-7 text-black text-2xl font-semibold">Services</h4>
                        <nav>
                            <ul class="space-y-4">
                                <li>
                                    <a href="#"
                                ...
                                <li>
                                    <a href="#"
                                        class="font-medium text-base text-black transition hover:text-pblue-500">Track Your
                                        Order</a>
                                </li>
                                <li>
                                    <a href="#"
                                        class="font-medium text-base text-black transition hover:text-pblue-500">Shipping</a>
                                </li>
                                <li>
                                    <a href="#"
                                        class="font-medium text-base text-black transition hover:text-pblue-500">Trade
                                        Program</a>
                                </li>
                            </ul>
                        </nav>
                    ...
                    <div class="md:col-span-6 lg:col-span-4 pt-8 lg:pt-0 lg:pl-12">
                        <h4 class="mb-7 text-black text-2xl font-semibold">
                            Official Info:
                        </h4>
                        <ul class="space-y-3">
                            <li class="flex space-x-2">
                                ...
                                <p class="text-black">30 Commercial Road Fratton, Australia</p>
                            </li>
                            <li class="flex space-x-2">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="tel:1-888-452-1505" class="text-black text-base">1-888-452-1505</a>
                            </li>
                        </ul>
                        <div class="mt-7">
                            <h4 class="font-medium text-black text-xl mb-4">
                                Subscribe Newsletter
                            </h4>
                            <form action="">
                                <div class="relative w-full">
                                    <input type="text"
                                        class="rounded-lg w-full border-0 focus:ring-1 text-black focus:ring-pblue-500 p-4 bg-[#363A4B]"
                                        placeholder="Email address">
                                    <button class="bg-pblue-500 right-0 absolute text-black rounded-r-lg p-4">
                                        Subscribe
                                    </button>
                                </div>
                            </form>
        ...
        <div class="px-4 bg-interface-100 py-5">
